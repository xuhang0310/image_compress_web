...
from watermark.lama.model.base import InpaintModel
from watermark.lama.model.ddim_sampler import DDIMSampler
from watermark.lama.model.plms_sampler import PLMSSampler
from watermark.lama.schema import Config, LDMSampler

torch.manual_seed(42)
import torch.nn as nn
from watermark.lama.helper import (
    download_model,
    norm_img,
    get_cache_path_by_url,
    load_jit_model,
)
from watermark.lama.model.utils import (
    make_beta_schedule,
    timestep_embedding,
)
